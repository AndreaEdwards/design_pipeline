...
#	pdb_from_uniprot = PDBFromUniprot()
	...
	done = ['1X15', '4N72', '4JDR', '2CMD', '2ZYA', '3NBU', '4TWZ', '1SRU', '1S7C', '4B2NA', '2J1N', '1U60AB', '1YAC', '2XUVABCD', '1Y00AB', '1W36D', '1W36B', '1W36C']
...
##	# Write output csv
##	# THIS WORKS. DO NOT CHANGE
		mutation_list_generator = MutationListGenerator(sequence_annotations, dna_sequences, pdb_code=pdb_code)
		mutation_list_generator.write_csv_output()
